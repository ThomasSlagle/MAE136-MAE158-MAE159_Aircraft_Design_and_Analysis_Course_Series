...
\begin{document}
    ...
    \label{sec:adv_tech}
        ...
        \begin{center}
            ...
            \captionof{figure}{Direct operating cost, per ton, per mile for the optimal aircraft configration using different technologies.}\label{fig:doc}
        \end{center}

        \begin{center}
            \includegraphics[scale=0.7]{tech_weight.PNG}
            \captionof{figure}{Takeoff Weight for the optimal aircraft configration using different technologies.}\label{fig:weight}
        \end{center}
    ...
    \label{sec:seat configuration}
        ...
        \begin{center}
            ...
            \captionof{figure}{Direct operating cost, per ton, per mile for the optimal aircraft configration using different seating configurations.}\label{fig:seats}
        \end{center}
