...
weight_tech = 'composite'#'aluminum' #'composite'
...
pm_ar_array = [np.array([]),np.array([]),np.array([]),np.array([]),np.array([]),np.array([]),np.array([]),np.array([]),np.array([]),np.array([]),np.array([]),np.array([]),np.array([]),np.array([]),np.array([]),np.array([]),np.array([]),np.array([]),np.array([]),np.array([]),np.array([]),np.array([]),np.array([]),np.array([]),np.array([]),np.array([]),np.array([]),np.array([]),np.array([]),np.array([])]
tm_ar_array = [np.array([]),np.array([]),np.array([]),np.array([]),np.array([]),np.array([]),np.array([]),np.array([]),np.array([]),np.array([]),np.array([]),np.array([]),np.array([]),np.array([]),np.array([]),np.array([]),np.array([]),np.array([]),np.array([]),np.array([]),np.array([]),np.array([]),np.array([]),np.array([]),np.array([]),np.array([]),np.array([]),np.array([]),np.array([]),np.array([])]
w_ar_array = [np.array([]),np.array([]),np.array([]),np.array([]),np.array([]),np.array([]),np.array([]),np.array([]),np.array([]),np.array([]),np.array([]),np.array([]),np.array([]),np.array([]),np.array([]),np.array([]),np.array([]),np.array([]),np.array([]),np.array([]),np.array([]),np.array([]),np.array([]),np.array([]),np.array([]),np.array([]),np.array([]),np.array([]),np.array([]),np.array([])]
...
T_a_1st = 62287
grad_1st = ((num_e-1)*T_a_1st - T_req_1st)/w_to * 100
#print(grad_1st)
...
grad_2nd = ((num_e-1)*T_a_1st - T_req_2nd)/w_to * 100
...
T_a_3rd = 47844
grad_3rd = ((num_e-1)*T_a_3rd - T_req_3rd)/w_to * 100
...
T_a_ap = 53260
grad_ap = ((num_e-1)*T_a_ap - T_req_ap)/w_1 * 100
...
T_req_ld = w_1/l_d_ld
T_a_ld = 67162
grad_ld = (num_e*T_a_ld - T_req_ld)/w_1 * 100
