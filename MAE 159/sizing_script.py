...
airfoil_type = 'conventional' #'supercritical
weight_tech = 'other'#'aluminum' #'composite'
ar = int(input('Enter Desired Aspect Ratio: '))
sweep_array = np.linspace(10, 40, 30) #int(input('Enter Desired Sweep Angle: ')) # degrees
...
asopect_array=np.array([np.array[()]])
print(pm_array)
print(tm_array)
print(w_array)
